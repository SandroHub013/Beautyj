    ...
    <main className="min-h-screen bg-neutral-950 pt-24">
      <div className="container mx-auto px-4 py-8 max-w-3xl">
        <header className="text-center mb-10">
          <h1 className="text-3xl md:text-4xl font-bold text-gold-500 mb-2">Termini e Condizioni</h1>
        ...
        <div className="bg-neutral-900 rounded-xl shadow-lg p-6 border border-gold-500/30 text-neutral-200 space-y-6">
          ...
          <p>Beauty J si riserva il diritto di modificare i presenti Termini e Condizioni in qualsiasi momento. Le modifiche saranno pubblicate su questa pagina.</p>
        </div>
      </div>
    </main>
  )
